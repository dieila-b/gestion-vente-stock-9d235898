...
import { useInternalUserSecurity } from "./use-internal-user-security";

export const useInternalUserMutations = (refetch: () => void) => {
  const { generateTemporaryPassword, sendWelcomeEmail, handleResetPassword } = useInternalUserSecurity();
